...
async def retrieve_shopping_list(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
...
async def delete_shopping_list(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await init_db("shopping_list.db", SHOP_TABLE_SQL)
